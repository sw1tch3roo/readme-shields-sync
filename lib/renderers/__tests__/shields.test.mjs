...
describe('renderers/shields', () => {
    it('generates GitHub badges when owner/repo is provided', () => {
        ...
        expect(ghCI('owner/repo', 'ci.yml')).toBe(
            '[![CI status](https://img.shields.io/github/actions/workflow/status/owner/repo/ci.yml?label=CI)](https://github.com/owner/repo/actions)',
        );
    });
    ...
    it('renders coverage badges for supported providers', () => {
        ...
        expect(coverageBadge('coveralls', 'owner/repo')).toBe(
            '[![coverage](https://img.shields.io/coverallsCoverage/github/owner/repo)](https://coveralls.io/github/owner/repo)',
        );
